...
| **9**  | **Seminário Hashing** <br> **Quarta:** Grupos 1 (Fundamentos/Funções) e 2 (Colisões/Encadeamento). <br> **Sexta:** Grupos 3 (End. Aberto) e 4 (Análise/Aplicações). | - Discutir vantagens e desvantagens de cada método de ordenação.<br>- Explorar aplicações práticas das listas encadeadas em diferentes contextos. | Apresentação, debates, pesquisa | Apostila, Notebooks |
