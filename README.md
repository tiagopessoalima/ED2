...
| **2**  | **Merge Sort** <br> **Descrição:** Apresentação do paradigma de divisão e conquista aplicado no Merge Sort, com detalhes de implementação, análise de complexidade e comparação com outros métodos de ordenação. | - Compreender o funcionamento do Merge Sort (dividir, conquistar e mesclar).<br>- Implementar o algoritmo e analisar sua complexidade.<br>- Comparar com métodos como Insertion Sort e Selection Sort. | Python/Java, algoritmos de ordenação | [Apostila](Apostila_Semana_02_(ED2).html), [Notebooks](Aula_Semana_02_(ED2).ipynb) |
