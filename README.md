...
| **9**  | **Seminário Hashing** <br> **Quarta:** Grupos 1 (Fundamentos/Funções) e 2 (Colisões/Encadeamento). <br> **Sexta:** Grupos 3 (End. Aberto) e 4 (Análise/Aplicações). | Abordagem completa de Hashing via apresentações autogeridas pelos alunos. | Apresentação, debates, pesquisa | [Orientações](Seminário1.pdf) |
| **10** | **Apresentação do Projeto 1** <br> Exposição oral do projeto HashSimPy para colegas e professores. Demonstração da ferramenta CLI desenvolvida e discussão dos resultados e aprendizados.	 | Comunicar de forma clara o problema, a solução baseada em MinHashing, a implementação em Python, os resultados da verificação de similaridade e os desafios/aprendizados durante as 5 semanas de desenvolvimento. Demonstrar a ferramenta funcionando.	| Apresentação Oral, Slides, Demonstração de Software (CLI), Síntese de Informação. | [Orientações](Projeto1.pdf) |
