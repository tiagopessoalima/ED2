...
| **9**  | **Seminário Hashing** <br> **Quarta:** Grupos 1 (Fundamentos/Funções) e 2 (Colisões/Encadeamento). <br> **Sexta:** Grupos 3 (End. Aberto) e 4 (Análise/Aplicações). | Abordagem completa de Hashing via apresentações autogeridas pelos alunos. | Apresentação, debates, pesquisa | [Orientações](Seminários-Hashing.pdf) |
