...
| **9**  | **Seminário 1** <br> **Temas Sugeridos:** <br>- "Merge Sort vs. Ǫuick Sort: quando usar cada um?" <br>- "Listas Encadeadas em Sistemas de Arquivos e Jogos" | - Discutir vantagens e desvantagens de cada método de ordenação.<br>- Explorar aplicações práticas das listas encadeadas em diferentes contextos. | Apresentação, debates, pesquisa | Apostila, Notebooks |
