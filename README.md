...
| **10** | **Projeto 1 - HashTablePy** <br> Implementar Tabela Hash em Python com Encadeamento Separado para colisões.	| - Construir uma classe HashTable funcional (put, get, delete). <br> - Compreender na prática hashing e tratamento de colisões.	| Python 3, Listas (list), Classes, Função Hash (hash(), %), Encadeamento Separado. | [Orientações](Projeto1.pdf) |
