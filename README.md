...
| **8**  | **Prova 1** <br> **Avaliação:** Conteúdo das semanas 1–6, incluindo teoria e resolução de problemas práticos. | - Avaliar o domínio dos conceitos de complexidade, algoritmos de ordenação e manipulação de listas. | Prova teórica e prática | Material de apoio disponibilizado |

| **9** | **Seminário Hashing** <br> **Quarta:** Grupos 1 (Fundamentos/Funções) e 2 (Colisões/Encadeamento). <br> **Sexta:** Grupos 3 (End. Aberto) e 4 (Análise/Aplicações). <br> Abordagem completa de Hashing via apresentações autogeridas pelos alunos. | - Compreender motivação, conceito e funções de hash.<br>- Explicar colisões e detalhar Encadeamento Separado.<br>- Detalhar e comparar técnicas de Endereçamento Aberto.<br>- Analisar desempenho (Big O, fator de carga).<br>- Explicar redimensionamento.<br>- Identificar e descrever aplicações reais. | Apresentação (alunos), Pesquisa, Q&A (alunos), Discussão, Exemplos Visuais, Análise Comparativa | Capítulos do livro sobre Hashing (completo), Links/Artigos sugeridos, Ferramentas de Visualização, Critérios de Avaliação |


| **10** | **Projeto 1** <br> **Tema:** Implementação de uma biblioteca de listas encadeadas (com operações avançadas, como inversão e detecção de ciclos) e comparação de algoritmos de ordenação em diferentes cenários. | - Consolidar o aprendizado integrando estruturas de listas e algoritmos de ordenação.<br>- Analisar o desempenho das implementações sob diferentes cargas de dados. | Projeto prático, desenvolvimento de código | Apostila, Notebooks |
